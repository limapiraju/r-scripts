...
path <- "C:/Users/User/Desktop/Python para Psic�logos/scripts-R/010 - AFC, AFCMG, Bifactor/"
setwd(path)
...
parameterestimates(fit, standardize=T,  boot.ci.type = "perc", rsquare = TRUE) # imprime todos os parametros estimados com IC
...
### Graficos do modelo de 5 fatores com MLM====
bfi5.model <- '# modelo de medida
AM =~ Am1 + Am2 + Am3 + Am4 + Am5
CO =~ Co1 + Co2 + Co3 + Co4 + Co5
EX =~ Ex1 + Ex2 + Ex3 + Ex4 + Ex5
