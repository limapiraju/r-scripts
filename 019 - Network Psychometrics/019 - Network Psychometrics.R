...
path <- "C:/Users/User/Desktop/Python para Psicólogos/scripts-R/019 - Network Psychometrics/"
setwd(path)
...
dev.off()
# paradoxo da informacao: muita informacao ? pouca informacao, poucas distincoes
...
# Matriz adjacente, fun??o getWmat
